...
def pipeline_json_read(path_data,proj_nm,pip_nm):
    ...
    try:
        new_path= os.path.expanduser(path_data["folder_path"])+path_data["Program"]+proj_nm+\
...
def orchestration_execution(prj_nm,paths_data,pip_nm,run_id,iter_value):
    ...
    file_path=os.path.expanduser(paths_data["folder_path"])+paths_data["Program"]+prj_nm+\
...
def restart_orchestration_execution(prj_nm,paths_data,pip_nm,run_id,iter_value):
    ...
    text_filepath=os.path.expanduser(paths_data["folder_path"])+paths_data["Program"]+prj_nm+\
