...
main_json_file,task_id,run_id, file_path,iter_value):
    ...
    try:
        ...
        output_df.at[index, ['threshold_voilated_flag', 'run_flag']] = 'N'
        ...
        if control_table_df.at[index, 'active'] == 'Y':
            ...
            if ge_flag == 'GE':
                ge_checks(func_name,default_parameters_dtypes,inputs_required,output_df,
                          index,control_table_df,ge_df)
            else:
...
dq_output_loc=None):
    ...
    try:
        ...
        write_to_txt1(task_id,'FAILED',file_path)
        audit(iter_value,main_json_file, task_id,run_id,'STATUS','FAILED')
        log2.exception("error in qc_check function %s.", str(error))
        raise error
...
def qc_pre_check(prj_nm,main_json_file,cm_json_file,paths_data,config_file_path,task_id,run_id,
    ...
    try:
        ...
        main_json_file['task']['data_quality_features']['data_decryption_required'] == 'N':
            ...
            pre_check_result = qc_check_function_calling(prj_nm,main_json_file,paths_data,task_id,
                                run_id,file_path,iter_value,cm_json_file, config_file_path)
...
def qc_report(pre_check_result,post_check_result,new_path,file_path,iter_value,json_data,
    ...
    try:
        ...
        write_to_txt1(task_id,'FAILED',file_path)
        audit(iter_value,json_data, task_id,run_id,'STATUS','FAILED')
