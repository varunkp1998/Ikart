...
sessions, dq_output_loc=None):
    ...
    try:
        ...
        bad_file_loc = os.path.expanduser(paths_data["folder_path"])+paths_data["programs"]+prj_nm+\
...
def qc_check_function_calling(prj_nm,main_json_file,paths_data,task_id,
    ...
    output_loc = os.path.expanduser(paths_data["folder_path"])+paths_data["programs"]+prj_nm+\
