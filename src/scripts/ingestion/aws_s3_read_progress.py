...
def read_data_with_or_without_chunk(json_data,src_file,default_header,row_count,
    ...
    default_escapechar = None if default_escapechar == "None" else default_escapechar
    ...
    default_select_cols = None if default_select_cols == "" else default_select_cols
    default_alias_cols = None if "alias_columns" not in source else default_alias_cols
