...
def execute_engine(prj_nm,task_name:str,paths_data:str,run_id:str,pip_nm:str,file_path):
    ...
    try:
        ...
        engine_code.engine_main(prj_nm,task_name,paths_data,run_id,pip_nm,file_path)
        log2.info('#####################################################')
    except Exception as error:
